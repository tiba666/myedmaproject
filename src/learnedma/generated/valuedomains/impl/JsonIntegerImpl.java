...
/**
 * The implementation of JsonInteger
 */
public class JsonIntegerImpl extends JsonInteger implements IValueInstance
{
     ...
     */
    public JsonIntegerImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this JsonInteger to another JsonInteger
     * @param jsonInteger  The JsonInteger to compare with
     * @return             A negative integer, zero, or a positive integer as
     *                     this JsonInteger is less than, equal to, or greater
     *                     than the specified JsonInteger
     */
    public int compareTo(JsonInteger jsonInteger)
    {
        return edma_domain.valueCompare(value, ((JsonIntegerImpl) jsonInteger).value);
    }
