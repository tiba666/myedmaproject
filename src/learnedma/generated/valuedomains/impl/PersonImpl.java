...
import learnedma.generated.valuedomains.impl.CourseListImpl;
...
public class PersonImpl extends Person implements IValueInstance
{
     ...
     */
    public CourseList courselsit()
    {
        return new CourseListImpl(value[1]);
    }
     ...
     */
    public JsonBoolean active()
    {
        return new JsonBooleanImpl(value[2]);
    }
}
